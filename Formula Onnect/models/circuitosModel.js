...
exports.postCircuitos = async (circuito) => {
  const query = 'INSERT INTO Circuitos (circuitId, nombreCircuito, urlCircuito, pais, isoPais, ciudad) VALUES (?, ?, ?, ?, ?, ?)';
  const values = [circuito.circuitId, circuito.nombreCircuito, circuito.urlCircuito, circuito.pais, circuito.isoPais, circuito.ciudad];
  try {
