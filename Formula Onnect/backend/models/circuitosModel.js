...
exports.postCircuitos = async (circuito) => {
  const query = 'INSERT INTO Circuitos (circuitId, nombreCircuito, urlCircuito, pais, isoPais, ciudad, primeraCarrera, ultimaCarrera, longitudCircuito, vueltas, recordPista, URLRecords, imagenCircuitos) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)';
  const values = [circuito.circuitId, circuito.nombreCircuito, circuito.urlCircuito, circuito.pais, circuito.isoPais, circuito.ciudad, circuito.primeraCarrera, circuito.ultimaCarrera, circuito.longitudCircuito, circuito.vueltas, circuito.recordPista, circuito.URLRecords, circuito.imagenCircuitos];
  try {
