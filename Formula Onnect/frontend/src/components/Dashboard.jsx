...
export const Dashboard = () => {
  ...
  return (
    <div style={{ paddingLeft: "1vh", height: "100vh", display: "flex", flexDirection: "column", width: "12vw" }} >
        ...
        <br />
        <button type="submit" onClick={handlePerfil} style={{ padding:"1vw", backgroundColor: location.pathname === "/Perfil" || location.pathname === "/PerfilPublicaciones" || location.pathname === "/EditarPerfil" || (location.pathname === "/Comentarios" && (prevPath === "/Perfil" || prevPath === "/PerfilPublicaciones")) || location.pathname === "/OtroPerfil" || location.pathname === "/PublicacionesOtroUsuario" ? "#C40000" : "#15151E", borderRadius: "1.5vh", height: "3vh", width: "11vw", display: "flex", flexDirection: "row", alignItems: "center", color: "white", border: "none" }}>
